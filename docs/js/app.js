 ...
 */
    ...
    (() => {
        ...
        var CityInfo = {
            kyiv: {
                name: "Київ",
                desc: "👉 Київ із зе кепітал оф грейт Юкрейн, бо вже грейт з 11 століття, коли був найбільшим містом у Європі."
            },
            kharkiv: {
                name: "Харків",
                desc: "👉 Навіть дорослі хочуть відкрити для себе платформу 9 3/4, Flintкривай магічне місто Харків на 50-й невидимій паралелі через весь земний шар."
            },
            odesa: {
                name: "Одесу",
                desc: "👉 Якщо ви з друзями годинами залипаєте у Фіфу на приставці, краще збирайте рюкзаки та Flintкривайте Одесу, поки літо не закінчилося: місто першого футбольного поля в Україні."
            },
            dnipro: {
                name: "Дніпро",
                desc: "👉 Місто-батьківщина сухариків Flint, які з’явилися тут у 2002 році! Доречі найпершим смаком сухариків цілого покоління став «Сметана із зеленню»."
            },
            lviv: {
                name: "Львів",
                desc: "👉 Тільки не кажи, що ти не дослідив кожну пам’ятку та кафешку у Львові, бо це місто яке увійшло в Топ-100 туристичних міст Європи. Тож бери рюкзак та запас сухарів і гайда з друзями вивчати кожен камінчик Львова, там дуууже багато цікавинок!"
            },
            vinnytsia: {
                name: "Вінницю",
                desc: "👉 Коли друзі кличуть гуляти, а ти не хочеш вилазити з комфортного ліжечка, Flintкривай із ними Вінницю, яка чотири рази очолювала опитування «Найкомфортніше місто для життя в Україні», яке проводилося групою «Рейтинг» для міжнародного республіканського інституту."
            },
            donetsk: {
                name: "Донецьк",
            ...
            poltava: {
                name: "Полтаву",
                desc: "👉 Flintкривай історію Полтави — столицю літературної української мови й першого твору написаного нею знамениту «Енеїду»."
            },
            zhytomyr: {
                name: "Житомир",
                desc: "👉 Важливе Flintкриття: кожна твоя зарплата родом із Житомирщини, адже саме Житомирщина — Батьківщина нашої національної валюти."
            },
            zaporizhzhia: {
                name: "Запоріжжя",
                desc: "👉 Хортиця — найбільший річковий острів саме на Дніпрі, який входить до списку 7 чудес України, а вже тільки 8-м можна назвати твою здібність не чути нікого, коли хрумтиш сухарики."
            },
            frankivsk: {
            ...
            sumy: {
                name: "Суми",
                desc: "👉 Як ти любиш великі пачки Flint, так Суми люблять свої найбільші печери Софроніївського монастиря."
            },
            rivne: {
                name: "Рівне",
            ...
            ternopil: {
                name: "Тернопіль",
                desc: "👉 PayPass, Face ID… А чи знав ти, що саме Тернопіль наш провідник у світ технологій: перше місто в Україні з електронним квитком у громадському транспорті."
            },
            uzhgorod: {
                name: "Ужгород",
                desc: "👉 Це рідкісне місто в Україні, у якого є власний торт — справжній конкурент «Київського». Тож із сувеніром з Ужгорода питання закрите."
            },
            kherson: {
                name: "Херсон",
            ...
            luhansk: {
                name: "Луганськ",
                desc: "👉 Щоби побачити єдинорога треба вирушати в Луганськ, де є унікальний експонат: гармата, названа «кріпаком єдинорогом», яку вилили на Луганському заводі. Дата її виготовлення — 1814 рік. Ця гармата — найстаріша з гаубиць, що стоять пам’ятниками в області."
            },
            lutsk: {
                name: "Луцьк",
                desc: "👉 Лучани вже багато років поспіль намагаються розкопати одне підземелля в пошуках скарбів. Майже як ти намагаєшся визначити, який смак Flint смачніший… здається і те, й інше неможливе!"
            },
            mykolaiv: {
                name: "Миколаїв",
            ...
            khmelnytskyi: {
                name: "Хмельницький",
                desc: "👉 Справжнім отаманом не народжуються — ним стають! І ти зможеш! Flint і дух Богдана Хмельницького підтримають твій козацький дух!"
            },
            chernihiv: {
                name: "Чернігів",
                desc: "👉 Чернігів настільки містичний і крутий, що має талісманом Семаргла — звіра з головою собаки і пташиними крилами. Справжнє місце для заряду енергією, особливо, якщо під час візиту їсти Flint)"
            },
            chernivtsi: {
                name: "Чернівці",
                desc: "👉 Не любиш прокидатися під нудний будильник, бо вчора весь вечір хрумтів сухариками під відеоігри? У Чернівцях тебе розбудить справжній трубач «Марічкою»."
            },
            cherkasy: {
                name: "Черкаси",
                desc: "👉 Додай свою історію до безлічі міських легенд про Черкаський палац одружень….або хоча б посидь на сходах із сухариками, Flint завжди привертає увагу))"
            }
        };
